...
namespace microbloom.Migrations
{
    ...
    [Migration("20260101004603_AddMentorship")]
    partial class AddMentorship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("microbloom.Entities.JobPosting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Location = "İstanbul",
                            PostedDate = new DateTime(2026, 1, 1, 0, 46, 2, 721, DateTimeKind.Utc).AddTicks(9643),
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Location = "Ankara",
                            PostedDate = new DateTime(2026, 1, 1, 0, 46, 2, 721, DateTimeKind.Utc).AddTicks(9645),
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            Location = "İstanbul",
                            PostedDate = new DateTime(2026, 1, 1, 0, 46, 2, 721, DateTimeKind.Utc).AddTicks(9646),
                            Title = "DevOps Mühendisi"
                        });
                });

            modelBuilder.Entity("microbloom.Entities.MentorshipApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("microbloom.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("microbloom.Entities.MentorshipApplication", b =>
                {
                    b.HasOne("microbloom.Entities.AppUser", "Mentee")
                        .WithMany()
                        .HasForeignKey("MenteeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("microbloom.Entities.AppUser", "Mentor")
                        .WithMany()
            ...
            modelBuilder.Entity("microbloom.Entities.Message", b =>
                {
                    b.HasOne("microbloom.Entities.AppUser", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("microbloom.Entities.AppUser", "Sender")
                        .WithMany()
